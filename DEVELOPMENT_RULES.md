...
These rules dictate the engineering approach for FoodieGo. They must be followed strictly by all human developers. (AI workflows are managed in \`AGENTS.md\`).
