...
import { Package, ArrowLeft, RefreshCw, AlertCircle, MapPin, Phone, Clock, Navigation } from 'lucide-react';
  ...
  if (isOrderError) {
    ...
    return (
      <div className="container mx-auto p-4 max-w-4xl space-y-4">
        <Button variant="ghost" onClick={() => navigate('/driver/deliveries')} className="mb-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div className="flex items-center space-x-4">
          <Button variant="outline" size="sm" onClick={() => navigate('/driver/deliveries')}>
            <ArrowLeft className="w-4 h-4 mr-2" /> Deliveries
          </Button>
