...
import { ArrowLeft, RefreshCw, AlertCircle, MapPin, Phone, Clock, User } from 'lucide-react';
  ...
  if (isOrderError) {
    ...
    return (
      <div className="container mx-auto p-4 max-w-4xl space-y-4">
        <Button variant="ghost" onClick={() => navigate('/merchant/orders')} className="mb-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {merchantStatusOptions.map((status) => (
                  <Button
                    key={status}
