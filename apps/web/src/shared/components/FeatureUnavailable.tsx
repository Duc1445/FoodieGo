    ...
    <div className="flex flex-col items-center justify-center p-8 text-center min-h-[50vh] bg-gray-50 rounded-lg border border-gray-100 m-4">
      ...
      {(actionLabel || onAction) && (
        <button 
          ...
          className="mt-6 px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          aria-label={actionLabel || 'Go Back'}
        >
          {actionLabel || 'Go Back'}
        </button>
      )}
