  ...
  for (const item of data) {
    await pool.query(
      `INSERT INTO promotions (
         id, code, discount_type, discount_value, min_order_value, valid_from, valid_until,
         is_active, promotion_type, restaurant_id, approval_status
       )
